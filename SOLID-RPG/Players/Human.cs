...
namespace SOLID_RPG.Players
{
    internal class Human : IRace
    {
        ...
        public Human(ILogger logger, IDiceRoller roller, string name, IWeaponFactory weaponFactory)
        {
            this.logger = logger;
            this.roller = roller;
            this.Name = name;
            this.Strength = roller.RollStatsDice(2, 6);
            this.Intelligence = roller.RollStatsDice(2, 6);
