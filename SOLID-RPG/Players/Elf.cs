...
namespace SOLID_RPG.Players
{
    internal class Elf : IRace
    {
        ...
        public Elf(ILogger logger, IDiceRoller roller, string name, IWeaponFactory weaponFactory)
        {
            this.logger = logger;
            this.roller = roller;
            this.Name = name;
            this.Strength = roller.RollStatsDice(1, 6);
            this.Intelligence = roller.RollStatsDice(3, 6);
